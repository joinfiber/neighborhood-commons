...
// Database type reference — generated by `npm run db:types`.
// Wire into createClient<Database>() once generated from the live schema.
// The placeholder in database.types.ts provides Row types for reads;
// full Insert/Update types require generation from Supabase CLI.
